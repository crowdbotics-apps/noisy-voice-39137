"""
Django settings for noisy_voice_39137 project.
...
ROOT_URLCONF = 'noisy_voice_39137.urls'
...
WSGI_APPLICATION = 'noisy_voice_39137.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_voice_39137 API",
    "DESCRIPTION": "API documentation for noisy_voice_39137 App",
    "VERSION": "v1",
}
